...
function dropDownMenu() {
    ...
    var compile_rcvTxn = "<form action='result.php' method='get'>" + "<input id='editor' type='hidden' name='contract' value='(tx(0).rcv = addr ZZAF5ARA4MEC5PVDOP64JM5O5MQST63Q2KOY2FLYFLXXD3PFSNJJBYAFZM)&/1'>" + "</input>" + "<input class='button success' type='submit' value='Compile this example'>" + "</input>" + "</form >";
    ...
    var compile_versig = "<form action='result.php' method='get'>" + "<input id='editor' type='hidden' name='contract' value='versig(arg(0),arg(1),addr ZZAF5ARA4MEC5PVDOP64JM5O5MQST63Q2KOY2FLYFLXXD3PFSNJJBYAFZM)&/3'>" + "</input>" + "<input class='button success' type='submit' value='Compile this example'>" + "</input>" + "</form >";


    // Oracle
    var oracle_text = "<b>" + "Oracle" + "</b>" + ". Either " + "<i>" + "a " + "</i>= ZZAF5ARA4MEC5PVDOP64JM5O5MQST63Q2KOY2FLYFLXXD3PFSNJJBYAFZM or " + "<i>" + "b " + "</i>" + "= SOEI4UA72A7ZL5P25GNISSVWW724YABSGZ7GHW5ERV4QKK2XSXLXGXPG5Y can withdraw all the Algos in the contract, depending on the outcome of a certain boolean event. Such an event is certified by an oracle " + "<i>" + "o " + "</i>" + "= NKOS3PFXD73DDFSEE6SSQQ6SEZGOQBTE6KQAGEDQZRGOCXSNH3XGCXWGHU by signing either the value 1 or 0. The contract only accepts a close tx. " + "<i>" + "arg(0) " + "</i>" + "is the event's outcome, " + "<i>" + "arg(1) " + "</i>" + "is " + "<i>" + "o" + "</i>" + "’s signature on (" + "<i>" + "Oracle" + "</i>" + "," + "<i>" + "arg(0)" + "</i>" + "). After round r" + "<sub>" + "max" + "</sub>" + " = 3000 , " + "<i>" + "a " + "</i>" + "can collect the money." + "<br>" + "The following " + "<i>" + "expression " + "</i>" + "encodes all constraints.";
    ...
    var oracle_code = "(" + "<br>" +
        ...
        "&nbsp&nbsp&nbsp&nbsp&nbsp" + ")" + "<br>" +
        ")" + "<br>";
    var compile_oracle = "<form action='result.php' method='get'>" + "<input id='editor' type='hidden' name='contract' value='((tx(0).type = int close) and (((tx(0).fv > int 3000) and (tx(0).crcv = addr ZZAF5ARA4MEC5PVDOP64JM5O5MQST63Q2KOY2FLYFLXXD3PFSNJJBYAFZM)) or (((arg(0) = byte base64 bXkgc3RyaW5n) and (versig(arg(0),arg(1),addr NKOS3PFXD73DDFSEE6SSQQ6SEZGOQBTE6KQAGEDQZRGOCXSNH3XGCXWGHU) and (tx(0).crcv = addr ZZAF5ARA4MEC5PVDOP64JM5O5MQST63Q2KOY2FLYFLXXD3PFSNJJBYAFZM))) or ((arg(0) = byte base64 bXkgc3RyaW5n) and (versig(arg(0),arg(1),addr NKOS3PFXD73DDFSEE6SSQQ6SEZGOQBTE6KQAGEDQZRGOCXSNH3XGCXWGHU) and (tx(0).crcv = addr SOEI4UA72A7ZL5P25GNISSVWW724YABSGZ7GHW5ERV4QKK2XSXLXGXPG5Y))))))&/4'>" + "</input>" + "<input class='button success' type='submit' value='Compile this example'>" + "</input>" + "</form >";


    // HTLC
    var htlc_text = "<b>" + "Hash Time Lock Contract (HTLC)" + "</b>" + ". A user " + "<i>" + "a " + "</i> " + " promises that she will either reveal a secret s" + "<sub>" + "a" + "</sub>" + " by round r" + "<sub>" + "max" + "</sub>" + "= 3000, or pay a penalty to " + " <i> " + "b" + "</i>" + ". More sophisticated contracts, e.g. gambling games, use this mechanism to let players generate random numbers in a fair way. We define the HTLC as the following contract, parameterised on the two users " + " <i> " + "a" + "</i>" + ", " + " <i>" + " b " + "</i> " + "and the hash h" + "<sub>" + "a" + "</sub>" + " = H(s" + "<sub>" + "a" + "</sub>" + ") of the secret." + "<br>Where<br>" + "a = ZZAF5ARA4MEC5PVDOP64JM5O5MQST63Q2KOY2FLYFLXXD3PFSNJJBYAFZM" + "<br>" + "b = SOEI4UA72A7ZL5P25GNISSVWW724YABSGZ7GHW5ERV4QKK2XSXLXGXPG5Y" + "<br>" + "H" + "<sub>" + "a" + "</sub>" + " = bXkgc3RyaW5n" + "<br>";
    ...
    var compile_htlc = "<form action='result.php' method='get'>" + "<input id='editor' type='hidden' name='contract' value='((tx(0).type = int close) and (((tx(0).rcv = addr ZZAF5ARA4MEC5PVDOP64JM5O5MQST63Q2KOY2FLYFLXXD3PFSNJJBYAFZM) and (H(arg(0)) = byte base64 bXkgc3RyaW5n)) or ((tx(0).rcv = addr SOEI4UA72A7ZL5P25GNISSVWW724YABSGZ7GHW5ERV4QKK2XSXLXGXPG5Y) and (tx(0).fv > int 3000))))&/5'>" + "</input>" + "<input class='button success' type='submit' value='Compile this example'>" + "</input>" + "</form >";
    ...
    var compile_pp = "<form action='result.php' method='get'>" + "<input id='editor' type='hidden' name='contract' value='((tx(0).type = int pay) and ((tx(0).val = int 10000) and ((tx(0).rcv = addr ZZAF5ARA4MEC5PVDOP64JM5O5MQST63Q2KOY2FLYFLXXD3PFSNJJBYAFZM) and (((tx(0).fv % int 2000) = int 0) and (((tx(0).lv = tx(0).fv) + int 2000) and (tx(0).lx = int 4000))))))&/6'>" + "</input>" + "<input class='button success' type='submit' value='Compile this example'>" + "</input>" + "</form >";
