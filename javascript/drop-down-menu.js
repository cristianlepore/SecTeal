...
function dropDownMenu() {
    ...
    var oracle_code = "(" + "<br>" +
        ...
        "&nbsp&nbsp&nbsp&nbsp&nbsp" + ")" + "<br>" +
        ")" + "<br>";
    var compile_oracle = "<form action='result.php' method='get'>" + "<input id='editor' type='hidden' name='contract' value='((tx(0).type = int close) and (((tx(0).fv > int 3000) and (tx(0).crcv = addr ZZAF5ARA4MEC5PVDOP64JM5O5MQST63Q2KOY2FLYFLXXD3PFSNJJBYAFZM)) or (((arg(0) = byte base64 bXkgc3RyaW5n) and (versig(arg(0),arg(1),addr NKOS3PFXD73DDFSEE6SSQQ6SEZGOQBTE6KQAGEDQZRGOCXSNH3XGCXWGHU) and (tx(0).crcv = addr ZZAF5ARA4MEC5PVDOP64JM5O5MQST63Q2KOY2FLYFLXXD3PFSNJJBYAFZM))) or ((arg(0) = byte base64 bXkgc3RyaW5n) and (versig(arg(0),arg(1),addr NKOS3PFXD73DDFSEE6SSQQ6SEZGOQBTE6KQAGEDQZRGOCXSNH3XGCXWGHU) and (tx(0).crcv = addr SOEI4UA72A7ZL5P25GNISSVWW724YABSGZ7GHW5ERV4QKK2XSXLXGXPG5Y))))))'>" + "</input>" + "<input class='button success' type='submit' value='Compile this example'>" + "</input>" + "</form >";
